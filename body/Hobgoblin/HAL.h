...
/* 
!!! Не забыть реализовать в классе Platform работу с выводами, 
а в классе Pin использовать вызовы методов класса Platform, а не функции Arduino.
Вообще все вызовы библиотечных функций Arduino постараться определить в классе Platform,
чтобы в дальнейшем была возможность безболезненной оптимизации кода и отказа от стандартных библиотечных функций.
 */
